...
export const translations: Record<Language, TranslationObject> = {
    fr: {
        ...
        'spot.bar.title': 'BARS',
        'spot.zenzi.description': 'Zenzi, c’est un peu la maison du bonheur au bord de la mer : tables les pieds dans le sable, parasols colorés, transats confortables et une playlist qui évolue au fil de la journée, passant des sets chill aux concerts live dès 17h. Chaque soir, des groupes locaux ou des DJs viennent enflammer l’endroit, avec des soirées salsa, électro ou rock selon les jours. Les dimanches après-midi, c’est BBQ à volonté avec une ambiance conviviale et festive.',
        'spot.chela.description': 'Chela de Playa, c’est bien plus qu’un simple bar : c’est une brasserie artisanale indépendante où la bière est une véritable passion. Nichée dans une ruelle tranquille à quelques pas de la 5e Avenue, cette adresse est un havre de fraîcheur et de convivialité. La terrasse, entourée de végétation, offre un cadre idéal pour savourer une bière fraîche tout en discutant entre amis ou en famille. La musique est présente sans être envahissante, créant ainsi une ambiance agréable et propice à la détente.',
